...
public class LiveXYChart { 
     ...
     */ 
    public void addYSeriesValues(double[] ySeries, String seriesName) throws Exception { 
        // create line series 
        ILineSeries lineSeries = (ILineSeries) fXyChart.getSeriesSet().getSeries(seriesName); 
        if (lineSeries == null) { 
            // (Messages.LiveXYChart_NoSeries); 
        } 
     ...
     *             An exception for invalid series 
     */ 
    public void addXSeriesValues(double[] xSeries, String seriesName) throws Exception { 
        // create line series 
